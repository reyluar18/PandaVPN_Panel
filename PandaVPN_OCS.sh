...
if [[ $vps = "vps" ]]; then
	source="https://raw.githubusercontent.com/reyluar18/PandaVPN_Panel/master"
else
	source="https://raw.githubusercontent.com/reyluar18/PandaVPN_Panel/master"
fi
...
read -p " Database Name: " -e -i OCS_PANEL_PandaVPN DatabaseName
echo ""
...
echo 'echo -e " ██║     ██║  ██║██║ ╚████║██████╔╝██║  ██║     ╚████╔╝ ██║     ██║ ╚████║ ' >> .bashrc
echo 'echo -e " ╚═╝     ╚═╝  ╚═╝╚═╝  ╚═══╝╚═════╝ ╚═╝  ╚═╝      ╚═══╝  ╚═╝     ╚═╝  ╚═══╝ ' >> .bashrc
echo 'echo -e "   ----------------- Created by Rey DC Luar Jr -------------------------  "' >> .bashrc
...
cd /home/vps/public_html
wget https://raw.githubusercontent.com/reyluar18/PandaVPN_Panel/master/OCSPanel.zip
unzip OCSPanel.zip
rm -f OCSPanel.zip
chown -R www-data:www-data /home/vps/public_html
